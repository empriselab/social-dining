...
input1 = Input(shape=(180, n_body_pose + n_hands_pose + n_face_pose + n_gaze_pose + n_head_pose, 1))
...
input2 = Input(shape=(180, n_body_pose + n_hands_pose + n_face_pose + n_gaze_pose + n_head_pose, 1))
...
conv25 = Conv2D(8, kernel_size=1, strides=2, kernel_initializer="he_normal", activation='relu', kernel_regularizer=l2(l2_value), bias_regularizer=l2(l2_value))(
    bn25)
pool22 = MaxPooling2D(pool_size=(2, 2))(conv25)
bn26 = BatchNormalization()(pool22)
flat2 = Flatten()(bn26)

input3 = Input(shape=(180, n_body_pose + n_hands_pose + n_face_pose + n_gaze_pose + n_head_pose, 1))
...
conv34 = Conv2D(16, kernel_size=3, strides=2, kernel_initializer="he_normal", activation='relu', kernel_regularizer=l2(l2_value), bias_regularizer=l2(l2_value))(
    bn34)
pool31 = MaxPooling2D(pool_size=(2, 2))(conv34)
